    ...
    <div class="tile">
      ...
      <div class="tile-body">
        ...
        <div class="row">
          ...
          <div class="col-md-3">
            <a class="btn btn-secondary" href="{{route('order.index')}}"><i class="fa fa-fw fa-lg fa-times-circle"></i>Cancel</a>&nbsp;&nbsp;&nbsp;<button class="btn btn-primary" type="submit"><i class="fa fa-fw fa-lg fa-check-circle"></i>Update</button>
          </div>
        </div>
        </form>
    </div>
