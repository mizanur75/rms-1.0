...
<html lang="en">
    <head>
        ...
        <script src="https://maps.googleapis.com/maps/api/js?key=AIzaSyDKoLO4UlOUAgSGVZgyMQT5LYbeWWJZCOw&callback=initMap"
  type="text/javascript"></script>
        <script>
            function initialize() {
                var mapCanvas = document.getElementById('map-canvas');
                var mapOptions = {
                    center: new google.maps.LatLng(23.728783, 90.393791),
                    zoom: 16,
                    scrollwheel: true,
                                ...
                                <form class="reservation-form" method="post" action="{{route('reservation')}}">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-6 col-sm-6">
                                            ...
                                            <div class="form-group">
                                                <input type="date" class="form-control reserve-form empty iconified" name="datepicker" id="dateTimePicker1" placeholder="&#xf017;  Time">
                                            </div>
                                        </div>
                ...
                <div class="row dis-table">
                    ...
                    <div class="col-xs-6 col-sm-6 dis-table-cell">
                        <div class="section-content">
                            ...
                            <p>+8801710472020</p>
                            <p>mizanurrahman615@gmail.com </p>
                        </div>
                    </div>
                </div>
                ...
                <div class="row">
                    <div class="col-md-6 col-md-offset-3">
                        <div class="copyright text-center">
                            <p>
                                &copy; Copyright, 2018 <a href="#">Your Website Link.</a> Theme by <a href="#"  target="_blank">Mizanur Rahman</a>
                            </p>
                        </div>
                    </div>
                </div>
